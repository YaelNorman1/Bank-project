    ...
    return (
        <Container>
            <Form>
                ...
                <Button type="submit" variant="success" name="deposit" onClick={saveTransaction}>Deposit</Button>
                <Button type="submit" variant="danger" name="withdraw" onClick={saveTransaction}>Withdraw</Button>
            </Form>
        </Container>
